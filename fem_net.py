...
class FEM_Net(nn.Module):
    def __init__(self, n_channels=3, n_classes=1, final_deconv=True):
        ...
        self.cab1 = FEM(filters[0])
        self.cab2 = FEM(filters[1])
        self.cab3 = FEM(filters[2])
        self.cab4 = FEM(filters[3])
